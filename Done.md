...
- [x] 3. 学习深度学习的系统[项目模板](https://github.com/L1aoXingyu/PyTorch-Project-Template)
...
### Week6
- [x] 1. 理解激活函数，权重初始化，batchnorm 对网络训练的影响
...
### Week7
- [x] 1. 理解更 fancy 的优化方法，更多的 normalize 以及正则化和迁移学习对网络训练的影响
